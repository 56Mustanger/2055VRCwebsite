...
window.Typekit.config = {
    "a": "72089600",
    "c": [".tk-nimbus-sans", "\"nimbus-sans\",sans-serif", ".tk-neue-haas-unica", "\"neue-haas-unica\",sans-serif"],
    "fi": [39512, 39516, 39519, 39521, 39523, 39524],
    "fc": [{
        "id": 39512,
        "family": "neue-haas-unica",
        "src": "https://use.typekit.net/af/8a8abc/00000000000000007735bb07/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "600",
            "style": "normal",
            "stretch": "normal",
        ...
        "id": 39516,
        "family": "neue-haas-unica",
        "src": "https://use.typekit.net/af/92a736/00000000000000007735bb14/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "stretch": "normal",
        ...
        "id": 39519,
        "family": "neue-haas-unica",
        "src": "https://use.typekit.net/af/5da8b8/00000000000000007735bb1e/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "300",
            "style": "normal",
            "stretch": "normal",
        ...
        "id": 39521,
        "family": "neue-haas-unica",
        "src": "https://use.typekit.net/af/579a71/00000000000000007735bb24/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "500",
            "style": "normal",
            "stretch": "normal",
        ...
        "id": 39523,
        "family": "neue-haas-unica",
        "src": "https://use.typekit.net/af/d7f1e9/00000000000000007735bb2a/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "stretch": "normal",
        ...
        "id": 39524,
        "family": "neue-haas-unica",
        "src": "https://use.typekit.net/af/1ae426/00000000000000007735bb2c/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "200",
            "style": "normal",
            "stretch": "normal",
    ...
    "fn": ["neue-haas-unica", ["n2", "n3", "n4", "n5", "n6", "n7"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.21.0",
    "kt": "iso0oez",
...
/*{"k":"1.21.0","auto_updating":true,"last_published":"2021-03-25 22:50:42 UTC"}*/
;
(function(window, document, undefined) {
        ...
        for (var b = "number" === typeof a, c = 0; c < this.i; c++) {
            ...
            if (b)
                ...
                var e,
                    ...
                    k = a.length - g;
                for (f = 0; f < k; f += 4)
                    e = (a.charCodeAt(f + 0) & 4294967295) << 0 | (a.charCodeAt(f + 1) &
                    4294967295) << 8 | (a.charCodeAt(f + 2) & 4294967295) << 16 | (a.charCodeAt(f + 3) & 4294967295) << 24,
                    e = q(e, 3432918353),
                    e = e << 15 | e >>> 17,
                    e = q(e, 461845907),
                    d ^= e,
    ...
    for (var W, m = window.Typekit.config || {}, Ha = [], Ja = m.fc, Ka = 0; Ka < Ja.length; Ka++)
        Ha.push(Ja[Ka].id);
    W = new T(Ia);
    m.ping && (W.m = new Ga);
    if (m.fc)
        for (var X = m.fc, Z = 0; Z < X.length; Z++)
            W.o.b.push(new ma(X[Z].family, X[Z].src, X[Z].descriptors));
    if (m.dl) {
        var La = m.dl;
        try {
            W.j = new ha(La)
